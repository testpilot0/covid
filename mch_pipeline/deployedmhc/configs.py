...
_query_sample_rate = 0.7 

#0.0001  # Generate a 0.01% random sample.
...
BIG_QUERY_QUERY = """
         SELECT
           ...
           peptide,
           result
           FROM `covid-19-271622.corona.mhc_qual_feature`
           where rand() <0.7
           """
# BIG_QUERY_QUERY = """
#         SELECT
